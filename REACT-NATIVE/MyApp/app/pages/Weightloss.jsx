...
import productImage from "../../assets/images/2025-Honda-Civic-Si.jpg";

const Weightlossproduct = () => {
  ...
  useEffect(() => {
    const fetchReviews = async () => {
      try {
        const res = await fetch("http://localhost:5000/reviews/category/Weightlossproduct");
    ...
    <View style={styles.container}>
      ...
      <ScrollView>
        {reviews && Object.keys(reviews).length ? (//Ensures that there is at least one review.
          ...
          <Text style={styles.noReviews}>No reviews available for Weightlossproducts.</Text>
        )}
      </ScrollView>
    </View>
  );
...
export default Weightlossproduct;
